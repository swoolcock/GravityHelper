...
{
    public class GravityFallingBlock : Solid
    {
        ...
        public GravityFallingBlock(Vector2 position, char tile, int width, int height, bool finalBoss, bool behind, bool climbFall)
        ...
        public GravityFallingBlock(EntityData data, Vector2 offset)
        ...
        private IEnumerator Sequence()
        {
            ...
            while (true)
            {
                ...
                while (true)
                {
                    ...
                    if (Top > (float)(level.Bounds.Bottom + 16) || (Top > (float)(level.Bounds.Bottom - 1) && CollideCheck<Solid>(Position + Vector2.UnitY)) ||
                        Bottom < (float)(level.Bounds.Top - 16) || (Bottom > (float)(level.Bounds.Top + 1) && CollideCheck<Solid>(Position - Vector2.UnitY)))
                    {
